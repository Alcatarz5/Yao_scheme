...
# print(generate_4x4_matrix("00112233445566778899aabbccddeeff"))
# Output    [['0', '4', '8', 'c'],
#           ['1', '5', '9', 'd'],
#           ['2', '6', 'a', 'e'],
#           ['3', '7', 'b', 'f']]
...
# Generate round key
def key_expansion(main_key_val):
...
#     text_1 = ["00", "11", "22", "33", "44", "55", "66", "77", "88", "99", "aa", "bb", "cc", "dd", "ee", "ff"]
#     key = "000102030405060708090a0b0c0d0e0f"
#     all_keys = key_expansion(key)
#     cipher_text = encrypt(text_1, all_keys)
#     print(f'{cipher_text} \n')
#     print(decrypt(cipher_text, all_keys))
